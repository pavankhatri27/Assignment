                        ...
                        <div class="row">
                            <div class="col-md-6 mx-auto">
                                <div class="card border-secondary">
                                    <div class="card-body">
                                        <form class="form" role="form" autocomplete="off" action="<?php echo base_url('registerAdd') ?>" id="form" enctype='multipart/form-data' method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="confirmPassword">Verify</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" id="profile" name="profile" accept=".jpg,.jpeg,.png">
                                            </div>
                                            <div class="form-group">
